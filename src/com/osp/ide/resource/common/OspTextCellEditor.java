...
public class OspTextCellEditor extends CellEditor {
	 ...
	 *            the parent control
	 */
	public OspTextCellEditor(Composite parent) {
	 ...
	 * @since 2.1
	 */
	public OspTextCellEditor(Composite parent, int style) {
		super(parent, style);
	}
	...
	protected Control createControl(Composite parent) {
		text = new Text(parent, getStyle() | SWT.RIGHT);
//		text.setOrientation(SWT.RIGHT_TO_LEFT);
		...
		text.addFocusListener(new FocusAdapter() {
			public void focusLost(FocusEvent e) {
				OspTextCellEditor.this.focusLost();
			}
		});
	...
	protected boolean dependsOnExternalFocusListener() {
		return getClass() != OspTextCellEditor.class;
	}
}
