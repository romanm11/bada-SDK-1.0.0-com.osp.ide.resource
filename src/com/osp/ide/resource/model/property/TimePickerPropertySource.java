...
public class TimePickerPropertySource extends OspNodePropertySource {

	public TimePickerPropertySource(EditTime node) {
		this.node = node;

		TIMEPICKER_INFO info = node.getItem().clone();
		this.info = info;
	...
	public Object getPropertyValue(Object id) {
		EditTime node = (EditTime) this.node;
	...
	public void resetPropertyValue(Object id) {
		TIMEPICKER_INFO info = (TIMEPICKER_INFO) this.info;
		EditTime node = (EditTime) this.node;
		...
		if (id.equals(FrameNode.PROPERTY_RENAME)) {
			...
			try {
				...
				Activator.setErrorMessage(
						"TimePickerPropertySource.setPropertyValue()", id
