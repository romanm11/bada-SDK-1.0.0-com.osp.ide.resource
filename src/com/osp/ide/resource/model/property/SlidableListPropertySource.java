...
public class SlidableListPropertySource extends OspNodePropertySource {

	public SlidableListPropertySource(SlidableList node) {
		this.node = node;

		SLIDABLELIST_INFO info = node.getItem().clone();
		this.info = info;
...
//		properties.add(ModeDescriptor);
	...
	public Object getPropertyValue(Object id) {
		SlidableList node = (SlidableList) this.node;
		String text = "";
	...
	public void resetPropertyValue(Object id) {
		SLIDABLELIST_INFO info = (SLIDABLELIST_INFO) this.info;
		SlidableList node = (SlidableList) this.node;
		...
		if (id.equals(FrameNode.PROPERTY_RENAME)) {
			...
			try {
				...
				Activator.setErrorMessage(
						"SlidableListPropertySource.setPropertyValue()", id
