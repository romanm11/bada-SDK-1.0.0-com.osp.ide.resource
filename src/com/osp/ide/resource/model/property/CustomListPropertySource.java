...
public class CustomListPropertySource extends OspNodePropertySource {

	public CustomListPropertySource(CustomList node) {
		this.node = node;

		CUSTOMLIST_INFO info = node.getItem().clone();
		this.info = info;
	...
	public Object getPropertyValue(Object id) {
		CustomList node = (CustomList) this.node;
	...
	public void resetPropertyValue(Object id) {
		CUSTOMLIST_INFO info = (CUSTOMLIST_INFO) this.info;
		CustomList node = (CustomList) this.node;
		...
		if (id.equals(FrameNode.PROPERTY_RENAME)) {
			...
			try {
				...
				Activator.setErrorMessage(
						"CustomListPropertySource.setPropertyValue()", id
