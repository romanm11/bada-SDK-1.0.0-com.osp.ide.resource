...
import com.osp.ide.resource.figure.SlidableGroupedListFigure;
...
public class SlidableGroupedListPart extends OspAbstractEditPart {

	@Override
	protected IFigure createFigure() {
		SlidableGroupedList cList = (SlidableGroupedList) getModel();
		SlidableGroupedListFigure figure = 
			new SlidableGroupedListFigure(cList.getParent().getScreen());
		this.figure = figure;
	...
	protected void refreshVisuals() {
		SlidableGroupedListFigure figure = (SlidableGroupedListFigure) getFigure();
		SlidableGroupedList model = (SlidableGroupedList) getModel();
