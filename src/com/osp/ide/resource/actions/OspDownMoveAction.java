...
import com.osp.ide.resource.commands.OspDownMoveCommand;
import com.osp.ide.resource.model.FrameNode;

public class OspDownMoveAction extends SelectionAction {
	public static final String ID = "com.osp.ide.resource.frame.DownMoveAction";

	public OspDownMoveAction(IWorkbenchPart part) {
		super(part);
	...
	private Command createMoveCommand(List<Object> selectedObjects) {
		...
		OspDownMoveCommand cmd = new OspDownMoveCommand();
