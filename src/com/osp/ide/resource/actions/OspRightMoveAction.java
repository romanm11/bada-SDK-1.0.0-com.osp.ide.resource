...
import com.osp.ide.resource.commands.OspRightMoveCommand;
import com.osp.ide.resource.model.FrameNode;

public class OspRightMoveAction extends SelectionAction {
	public static final String ID = "com.osp.ide.resource.frame.RightMoveAction";

	public OspRightMoveAction(IWorkbenchPart part) {
		super(part);
	...
	private Command createMoveCommand(List<Object> selectedObjects) {
		...
		OspRightMoveCommand cmd = new OspRightMoveCommand();
