...
public class OspRulerComposite extends Composite {
	 ...
	 */
	public OspRulerComposite(Composite parent, int style) {
		super(parent, style);
		...
		extends ScrollingGraphicalViewer
	{
		 ...
		 */
		protected void init() {
			setContextMenu(new OspRulerContextMenuProvider(this));
